...
(function(exports) {
  ...
  class ConsoleLoggerProvider {
    log(severity, content, category) {
      console.log(`${this.color(severity)} ${category ? "[35m" + category + "[0m " : ""}${content}`);
    }
    color(severity) {
      switch (severity) {
        case "verbose":
      ...
      (function(fbs) {
        class Shape {
          ...
          dim(index2, obj) {
            ...
            return offset ? (obj || new onnxruntime.experimental.fbs.Dimension()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          dimLength() {
            let offset = this.bb.__offset(this.bb_pos, 4);
    ...
    (function(experimental) {
      (function(fbs) {
        class NodeEdge {
          ...
          inputEdges(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? (obj || new onnxruntime.experimental.fbs.EdgeEnd()).__init(this.bb.__vector(this.bb_pos + offset) + index2 * 12, this.bb) : null;
          }
          inputEdgesLength() {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          }
          outputEdges(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 8);
            return offset ? (obj || new onnxruntime.experimental.fbs.EdgeEnd()).__init(this.bb.__vector(this.bb_pos + offset) + index2 * 12, this.bb) : null;
          }
          outputEdgesLength() {
    ...
    (function(experimental) {
      (function(fbs) {
        class Node2 {
          ...
          inputs(index2, optionalEncoding) {
            let offset = this.bb.__offset(this.bb_pos, 20);
            return offset ? this.bb.__string(this.bb.__vector(this.bb_pos + offset) + index2 * 4, optionalEncoding) : null;
          }
          inputsLength() {
            let offset = this.bb.__offset(this.bb_pos, 20);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          }
          outputs(index2, optionalEncoding) {
          ...
          attributes(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 24);
            return offset ? (obj || new onnxruntime.experimental.fbs.Attribute()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          attributesLength() {
            let offset = this.bb.__offset(this.bb_pos, 24);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          }
          inputArgCounts(index2) {
            let offset = this.bb.__offset(this.bb_pos, 26);
            return offset ? this.bb.readInt32(this.bb.__vector(this.bb_pos + offset) + index2 * 4) : 0;
          }
          ...
          implicitInputs(index2, optionalEncoding) {
          ...
          static addIndex(builder, index2) {
            builder.addFieldInt32(4, index2, 0);
          }
          ...
          static createNode(builder, nameOffset, docStringOffset, domainOffset, sinceVersion, index2, opTypeOffset, type, executionProviderTypeOffset, inputsOffset, outputsOffset, attributesOffset, inputArgCountsOffset, implicitInputsOffset) {
    ...
    (function(experimental) {
      (function(fbs) {
        class Tensor2 {
          ...
          dims(index2) {
            let offset = this.bb.__offset(this.bb_pos, 8);
            return offset ? this.bb.readInt64(this.bb.__vector(this.bb_pos + offset) + index2 * 8) : this.bb.createLong(0, 0);
          }
          dimsLength() {
            let offset = this.bb.__offset(this.bb_pos, 8);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          rawData(index2) {
            let offset = this.bb.__offset(this.bb_pos, 12);
            return offset ? this.bb.readUint8(this.bb.__vector(this.bb_pos + offset) + index2) : 0;
          }
          rawDataLength() {
            let offset = this.bb.__offset(this.bb_pos, 12);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          stringData(index2, optionalEncoding) {
            let offset = this.bb.__offset(this.bb_pos, 14);
            return offset ? this.bb.__string(this.bb.__vector(this.bb_pos + offset) + index2 * 4, optionalEncoding) : null;
          }
          stringDataLength() {
    ...
    (function(experimental) {
      (function(fbs) {
        class Attribute2 {
          ...
          floats(index2) {
            let offset = this.bb.__offset(this.bb_pos, 20);
            return offset ? this.bb.readFloat32(this.bb.__vector(this.bb_pos + offset) + index2 * 4) : 0;
          }
          floatsLength() {
            let offset = this.bb.__offset(this.bb_pos, 20);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          strings(index2, optionalEncoding) {
            let offset = this.bb.__offset(this.bb_pos, 24);
            return offset ? this.bb.__string(this.bb.__vector(this.bb_pos + offset) + index2 * 4, optionalEncoding) : null;
          }
          stringsLength() {
          ...
          tensors(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 26);
            return offset ? (obj || new onnxruntime.experimental.fbs.Tensor()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          tensorsLength() {
            let offset = this.bb.__offset(this.bb_pos, 26);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          graphs(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 28);
            return offset ? (obj || new onnxruntime.experimental.fbs.Graph()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          graphsLength() {
            let offset = this.bb.__offset(this.bb_pos, 28);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    ...
    (function(experimental) {
      (function(fbs) {
        class Graph {
          ...
          nodeArgs(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? (obj || new onnxruntime.experimental.fbs.ValueInfo()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          nodeArgsLength() {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          nodes(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 8);
            return offset ? (obj || new onnxruntime.experimental.fbs.Node()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          nodesLength() {
            let offset = this.bb.__offset(this.bb_pos, 8);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          nodeEdges(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 12);
            return offset ? (obj || new onnxruntime.experimental.fbs.NodeEdge()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          nodeEdgesLength() {
            let offset = this.bb.__offset(this.bb_pos, 12);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          sparseInitializers(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 18);
            return offset ? (obj || new onnxruntime.experimental.fbs.SparseTensor()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
    ...
    (function(experimental) {
      (function(fbs) {
        class Model2 {
          ...
          opsetImport(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? (obj || new onnxruntime.experimental.fbs.OperatorSetId()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
          opsetImportLength() {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    ...
    (function(experimental) {
      (function(fbs) {
        class KernelCreateInfos {
          ...
          nodeIndices(index2) {
            let offset = this.bb.__offset(this.bb_pos, 4);
            return offset ? this.bb.readUint32(this.bb.__vector(this.bb_pos + offset) + index2 * 4) : 0;
          }
          nodeIndicesLength() {
            let offset = this.bb.__offset(this.bb_pos, 4);
            return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
          ...
          kernelDefHashes(index2) {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? this.bb.readUint64(this.bb.__vector(this.bb_pos + offset) + index2 * 8) : this.bb.createLong(0, 0);
          }
    ...
    (function(experimental) {
      (function(fbs) {
        class SessionState {
          ...
          subGraphSessionStates(index2, obj) {
            let offset = this.bb.__offset(this.bb_pos, 6);
            return offset ? (obj || new onnxruntime.experimental.fbs.SubGraphSessionState()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index2 * 4), this.bb) : null;
          }
...
class ShapeUtil {
  ...
  static incrementIndex(index2, dims, axisToIncrementOn) {
    if (dims.length === 0 || index2.length === 0) {
...
function getReshapedInputCoords(shape2) {
  ...
  const coordsFromIndexSnippet = strides.map((stride, i) => {
    const line1 = `int ${coords[i]} = ${index2} / ${stride}`;
    const line2 = i === strides.length - 1 ? `int ${coords[i + 1]} = ${index2} - ${coords[i]} * ${stride}` : `index -= ${coords[i]} * ${stride}`;
    return `${line1}; ${line2};`;
  }).join("");
  return `
...
const createSplitProgramInfo = (inferenceHandler2, input, attributes, axis, index2) => {
  const [shapes, offsets] = util_1$6.SplitUtil.splitShape(input.dims, axis, attributes.split, attributes.numOutputs);
  const offset = offsets[index2];
  const outputShape = shapes[index2];
  const rank = outputShape.length;
  const shaderSource = `
      float process(int indices[${rank}]) {
        indices[${axis}] += ${offset};
    ...
    `;
  return Object.assign(Object.assign({}, splitProgramMetadata), { cacheHint: `${attributes.cacheKey}:${index2}`, output: { dims: outputShape, type: input.type, textureType: types_1$2.TextureType.unpacked }, shaderSource });
};
  ...
  releaseTexture(textureData, deleteTexture) {
    ...
    if (this.config.reuseTextures) {
      ...
      if (key) {
        ...
        if (inUseTextures) {
          const index2 = inUseTextures.indexOf(textureData.texture);
          if (index2 !== -1) {
            inUseTextures.splice(index2, 1);
...
class RedFloat32DataEncoder {
  ...
  decode(buffer, dataSize) {
    if (this.channelSize === 1) {
      const filteredData = buffer.filter((value, index2) => index2 % 4 === 0).subarray(0, dataSize);
      return filteredData;
    }
  ...
  async execute(sessionHandler2, modelInputs) {
    return this.profiler.event("session", "ExecutionPlan.execute", async () => {
      ...
      modelInputs.forEach((input, i) => {
        const index2 = graphInputs[i];
        this._values[index2] = input;
      });
...
class GraphImpl {
  ...
  buildGraphFromOnnxFormat(graph2) {
    ...
    for (const i of graph2.initializer) {
      let index2 = dataIndices.get(i.name);
      if (index2 === void 0) {
        ...
        index2 = this._allData.push(value) - 1;
        dataIndices.set(i.name, index2);
      }
      this._allData[index2]._from = -1;
      this._allData[index2].tensor = tensor_1$1.Tensor.fromProto(i);
    }
  ...
  buildGraphFromOrtFormat(graph2) {
    ...
    for (let i = 0; i < graph2.initializersLength(); i++) {
      ...
      let index2 = dataIndices.get(initializer.name());
      if (index2 === void 0) {
        const value = new Value();
        ...
        value.type = { shape: { dims }, tensorType: type };
        index2 = this._allData.push(value) - 1;
        dataIndices.set(initializer.name(), index2);
      }
      this._allData[index2]._from = -1;
      this._allData[index2].tensor = tensor_1$1.Tensor.fromOrtTensor(initializer);
    }
    for (let i = 0; i < this._allData.length; i++) {
      if (!this._allData[i].tensor) {
        this._allInputIndices.push(i);
  ...
  deleteNode(nodeIndex) {
    ...
    const index2 = this._allOutputIndices.indexOf(outputValueIndex);
    if (index2 !== -1) {
      this._allOutputIndices[index2] = inputValueIndex;
    }
...
(function(module, exports) {
  var ortWasm2 = function() {
    ...
    return function(ortWasm3) {
      ...
      var r = {}, t;
      for (t in c)
        c.hasOwnProperty(t) && (r[t] = c[t]);
      var v = "./this.program", ba = typeof window === "object", w = typeof importScripts === "function", ca = typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string", x = "", y, z, B, C, D;
      if (ca)
        x = w ? require$$3$1.dirname(x) + "/" : __dirname + "/", y = function(a, b) {
          C || (C = require$$3$1);
          D || (D = require$$3$1);
          a = D.normalize(a);
          return C.readFileSync(a, b ? null : "utf8");
        }, B = function(a) {
          a = y(a, true);
          ...
          D || (D = require$$3$1);
          a = D.normalize(a);
          C.readFile(a, function(f, h) {
            f ? e(f) : b(h.buffer);
          });
        }, 1 < process.argv.length && (v = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), process.on("uncaughtException", function(a) {
          throw a;
        }), process.on("unhandledRejection", E), c.inspect = function() {
          return "[Emscripten Module object]";
        };
      else if (ba || w)
        w ? x = self.location.href : typeof document !== "undefined" && document.currentScript && (x = document.currentScript.src), _scriptDir && (x = _scriptDir), x.indexOf("blob:") !== 0 ? x = x.substr(0, x.lastIndexOf("/") + 1) : x = "", y = function(a) {
      ...
      var da = c.print || console.log.bind(console), F = c.printErr || console.warn.bind(console);
      for (t in r)
        r.hasOwnProperty(t) && (c[t] = r[t]);
      r = null;
      c.thisProgram && (v = c.thisProgram);
      var H;
      c.wasmBinary && (H = c.wasmBinary);
      c.noExitRuntime || false;
      typeof WebAssembly !== "object" && E("no native wasm support detected");
      var I, ea = false, fa = typeof TextDecoder !== "undefined" ? new TextDecoder("utf8") : void 0;
      function ha(a, b, e) {
        var f = b + e;
        for (e = b; a[e] && !(e >= f); )
          ++e;
        if (16 < e - b && a.subarray && fa)
          return fa.decode(a.subarray(b, e));
        for (f = ""; b < e; ) {
          var h = a[b++];
          if (h & 128) {
            var k = a[b++] & 63;
      ...
      if (!ua()) {
        var va = Q;
        Q = c.locateFile ? c.locateFile(va, x) : x + va;
      }
      function wa() {
        var a = Q;
        try {
      ...
      function xa() {
        if (!H && (ba || w)) {
          if (typeof fetch === "function" && !Q.startsWith("file://"))
            return fetch(Q, { credentials: "same-origin" }).then(function(a) {
              if (!a.ok)
      ...
      function ya(a) {
        for (; 0 < a.length; ) {
          ...
          if (typeof b == "function")
            ...
            var e = b.Ea;
            typeof e === "number" ? b.xa === void 0 ? na.get(e)() : na.get(e)(b.xa) : e(b.xa === void 0 ? null : b.xa);
          }
        }
      }
      function za(a) {
      ...
      function Ea() {
        if (!Fa) {
          var a = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator === "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: v || "./this.program" }, b;
          for (b in Da)
            Da[b] === void 0 ? delete a[b] : a[b] = Da[b];
          var e = [];
          for (b in a)
            e.push(b + "=" + a[b]);
          Fa = e;
      ...
      function Ga() {
        ...
        if (!Ka) {
          Ka = true;
          var b = new Date().getFullYear(), e = new Date(b, 0, 1), f = new Date(b, 6, 1);
          b = e.getTimezoneOffset();
          var h = f.getTimezoneOffset(), k = Math.max(b, h);
          N[La() >> 2] = 60 * k;
          N[Ma() >> 2] = Number(b != h);
          e = a(e);
          f = a(f);
          e = ja(e);
          f = ja(f);
          h < b ? (N[U() >> 2] = e, N[U() + 4 >> 2] = f) : (N[U() >> 2] = f, N[U() + 4 >> 2] = e);
        }
      }
      var Ka;
      function V(a) {
      ...
      function Oa(a, b, e, f) {
        ...
        function l(d, m) {
          function n(Ha) {
            return 0 > Ha ? -1 : 0 < Ha ? 1 : 0;
          }
          var A;
          (A = n(d.getFullYear() - m.getFullYear())) === 0 && (A = n(d.getMonth() - m.getMonth())) === 0 && (A = n(d.getDate() - m.getDate()));
          return A;
        }
        function q(d) {
          switch (d.getDay()) {
        ...
        function G(d) {
          d = Y(new Date(d.va + 1900, 0, 1), d.Ca);
          var m = new Date(d.getFullYear() + 1, 0, 4), n = q(new Date(d.getFullYear(), 0, 4));
          m = q(m);
          return 0 >= l(n, d) ? 0 >= l(m, d) ? d.getFullYear() + 1 : d.getFullYear() : d.getFullYear() - 1;
        }
        var u = N[f + 40 >> 2];
        f = { Qa: N[f >> 2], Pa: N[f + 4 >> 2], Aa: N[f + 8 >> 2], za: N[f + 12 >> 2], wa: N[f + 16 >> 2], va: N[f + 20 >> 2], Ba: N[f + 24 >> 2], Ca: N[f + 28 >> 2], Ya: N[f + 32 >> 2], Oa: N[f + 36 >> 2], Ra: u ? J(u) : "" };
        e = J(e);
        ...
        for (var p in u)
          e = e.replace(new RegExp(p, "g"), u[p]);
        var Ia = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), Ja = "January February March April May June July August September October November December".split(" ");
        u = { "%a": function(d) {
          return Ia[d.Ba].substring(0, 3);
        }, "%A": function(d) {
          return Ia[d.Ba];
        }, "%b": function(d) {
          return Ja[d.wa].substring(0, 3);
        }, "%B": function(d) {
          return Ja[d.wa];
        }, "%C": function(d) {
          return k((d.va + 1900) / 100 | 0, 2);
        }, "%d": function(d) {
          return k(d.za, 2);
        }, "%e": function(d) {
          return h(d.za, 2, " ");
        }, "%g": function(d) {
          return G(d).toString().substring(2);
        }, "%G": function(d) {
          return G(d);
        }, "%H": function(d) {
          return k(d.Aa, 2);
          ...
          return k(d.za + Na(V(d.va + 1900) ? W : X, d.wa - 1), 3);
        }, "%m": function(d) {
          return k(d.wa + 1, 2);
        }, "%M": function(d) {
          return k(d.Pa, 2);
          ...
          var m = new Date(d.va + 1900, 0, 1), n = m.getDay() === 0 ? m : Y(m, 7 - m.getDay());
          d = new Date(d.va + 1900, d.wa, d.za);
          return 0 > l(n, d) ? k(Math.ceil((31 - n.getDate() + (Na(V(d.getFullYear()) ? W : X, d.getMonth() - 1) - 31) + d.getDate()) / 7), 2) : l(n, m) === 0 ? "01" : "00";
        }, "%V": function(d) {
          var m = new Date(d.va + 1901, 0, 4), n = q(new Date(d.va + 1900, 0, 4));
          m = q(m);
          var A = Y(new Date(d.va + 1900, 0, 1), d.Ca);
          return 0 > l(A, n) ? "53" : 0 >= l(m, A) ? "01" : k(Math.ceil((n.getFullYear() < d.va + 1900 ? d.Ca + 32 - n.getDate() : d.Ca + 1 - n.getDate()) / 7), 2);
        }, "%w": function(d) {
          return d.Ba;
        }, "%W": function(d) {
          var m = new Date(d.va, 0, 1), n = m.getDay() === 1 ? m : Y(m, m.getDay() === 0 ? 1 : 7 - m.getDay() + 1);
          d = new Date(d.va + 1900, d.wa, d.za);
          return 0 > l(n, d) ? k(Math.ceil((31 - n.getDate() + (Na(V(d.getFullYear()) ? W : X, d.getMonth() - 1) - 31) + d.getDate()) / 7), 2) : l(n, m) === 0 ? "01" : "00";
        }, "%y": function(d) {
          return (d.va + 1900).toString().substring(2);
        }, "%Y": function(d) {
          return d.va + 1900;
        }, "%z": function(d) {
          d = d.Oa;
        ...
        for (p in u)
          e.includes(p) && (e = e.replace(new RegExp(p, "g"), u[p](f)));
        p = Pa(e);
        if (p.length > b)
          return 0;
        M.set(p, a);
      ...
      var Ta = {
        ...
        K: function(a, b, e, f, h, k) {
          ...
          if ((f & 16) !== 0 && a % 65536 !== 0)
            ...
            var l = Qa(65536, a);
            l ? (K.fill(0, l, l + a), a = l) : a = 0;
            a ? (Ba[a] = { Ia: a, Ha: b, Fa: true, fd: h, Xa: e, flags: f, offset: k }, b = a) : b = -48;
          } else
            b = -52;
          return b;
        },
        J: function(a, b) {
          var e = Ba[a];
          b !== 0 && e ? (b === e.Ha && (Ba[a] = null, e.Fa && Ra(e.Ia)), a = 0) : a = -28;
          return a;
        },
        j: function() {
        },
        ...
        i: function(a) {
          ...
          for (var e = 1; 4 >= e; e *= 2) {
            ...
            a: {
              try {
                I.grow(Math.min(2147483648, f) - la.byteLength + 65535 >>> 16);
                ma();
                var h = 1;
                break a;
              } catch (k) {
        ...
        q: function(a, b, e, f) {
          for (var h = 0, k = 0; k < e; k++) {
            for (var l = N[b + 8 * k >> 2], q = N[b + (8 * k + 4) >> 2], G = 0; G < q; G++) {
              var u = K[l + G], p = Ca[a];
              u === 0 || u === 10 ? ((a === 1 ? da : F)(ha(p, 0)), p.length = 0) : p.push(u);
            }
            h += q;
          }
          N[f >> 2] = h;
        ...
        l: function(a, b) {
          ...
          a = (f != e && a.getTimezoneOffset() == Math.min(e, f)) | 0;
          N[b + 32 >> 2] = a;
          a = N[U() + (a ? 4 : 0) >> 2];
          N[b + 40 >> 2] = a;
          return b;
        ...
        k: function(a) {
          Ga();
          var b = new Date(N[a + 20 >> 2] + 1900, N[a + 16 >> 2], N[a + 12 >> 2], N[a + 8 >> 2], N[a + 4 >> 2], N[a >> 2], 0), e = N[a + 32 >> 2], f = b.getTimezoneOffset(), h = new Date(b.getFullYear(), 0, 1), k = new Date(b.getFullYear(), 6, 1).getTimezoneOffset(), l = h.getTimezoneOffset(), q = Math.min(l, k);
          0 > e ? N[a + 32 >> 2] = Number(k != l && q == f) : 0 < e != (q == f) && (k = Math.max(l, k), b.setTime(b.getTime() + 6e4 * ((0 < e ? q : k) - f)));
          N[a + 24 >> 2] = b.getDay();
      ...
      (function() {
        ...
        function e(h) {
          return xa().then(function(k) {
            return WebAssembly.instantiate(k, f);
          }).then(h, function(k) {
            F("failed to asynchronously prepare wasm: " + k);
            E(k);
          });
        }
        var f = { a: Ta };
        ...
        if (c.instantiateWasm)
          try {
            ...
            return F("Module.instantiateWasm callback failed with error: " + h), false;
          }
        (function() {
          return H || typeof WebAssembly.instantiateStreaming !== "function" || ua() || Q.startsWith("file://") || typeof fetch !== "function" ? e(b) : fetch(Q, { credentials: "same-origin" }).then(function(h) {
            return WebAssembly.instantiateStreaming(h, f).then(b, function(k) {
              F("wasm streaming compile failed: " + k);
      ...
      c.___wasm_call_ctors = function() {
        return (c.___wasm_call_ctors = c.asm.S).apply(null, arguments);
      };
      c._OrtInit = function() {
        return (c._OrtInit = c.asm.T).apply(null, arguments);
      };
      c._OrtCreateSessionOptions = function() {
        return (c._OrtCreateSessionOptions = c.asm.U).apply(null, arguments);
      };
      c._OrtAddSessionConfigEntry = function() {
        return (c._OrtAddSessionConfigEntry = c.asm.V).apply(null, arguments);
      };
      c._OrtReleaseSessionOptions = function() {
        return (c._OrtReleaseSessionOptions = c.asm.W).apply(null, arguments);
      };
      c._OrtCreateSession = function() {
        return (c._OrtCreateSession = c.asm.X).apply(null, arguments);
      };
      c._OrtReleaseSession = function() {
        return (c._OrtReleaseSession = c.asm.Y).apply(null, arguments);
      };
      c._OrtGetInputCount = function() {
        return (c._OrtGetInputCount = c.asm.Z).apply(null, arguments);
      };
      c._OrtGetOutputCount = function() {
        return (c._OrtGetOutputCount = c.asm._).apply(null, arguments);
      };
      c._OrtGetInputName = function() {
        return (c._OrtGetInputName = c.asm.$).apply(null, arguments);
      };
      c._OrtGetOutputName = function() {
        return (c._OrtGetOutputName = c.asm.aa).apply(null, arguments);
      };
      c._OrtFree = function() {
        return (c._OrtFree = c.asm.ba).apply(null, arguments);
      };
      c._OrtCreateTensor = function() {
        return (c._OrtCreateTensor = c.asm.ca).apply(null, arguments);
      };
      c._OrtGetTensorData = function() {
        return (c._OrtGetTensorData = c.asm.da).apply(null, arguments);
      };
      c._OrtReleaseTensor = function() {
        return (c._OrtReleaseTensor = c.asm.ea).apply(null, arguments);
      };
      c._OrtCreateRunOptions = function() {
        return (c._OrtCreateRunOptions = c.asm.fa).apply(null, arguments);
      };
      c._OrtAddRunConfigEntry = function() {
        return (c._OrtAddRunConfigEntry = c.asm.ga).apply(null, arguments);
      };
      c._OrtReleaseRunOptions = function() {
        return (c._OrtReleaseRunOptions = c.asm.ha).apply(null, arguments);
      };
      c._OrtRun = function() {
        return (c._OrtRun = c.asm.ia).apply(null, arguments);
      };
      c._OrtEndProfiling = function() {
        return (c._OrtEndProfiling = c.asm.ja).apply(null, arguments);
      };
      var ka = c._malloc = function() {
        return (ka = c._malloc = c.asm.ka).apply(null, arguments);
      }, Sa = c.___errno_location = function() {
        return (Sa = c.___errno_location = c.asm.la).apply(null, arguments);
      }, Ra = c._free = function() {
        return (Ra = c._free = c.asm.ma).apply(null, arguments);
      }, U = c.__get_tzname = function() {
        return (U = c.__get_tzname = c.asm.na).apply(null, arguments);
      }, Ma = c.__get_daylight = function() {
        return (Ma = c.__get_daylight = c.asm.oa).apply(null, arguments);
      }, La = c.__get_timezone = function() {
        return (La = c.__get_timezone = c.asm.pa).apply(null, arguments);
      }, Ua = c.stackSave = function() {
        return (Ua = c.stackSave = c.asm.qa).apply(null, arguments);
      }, Va = c.stackRestore = function() {
        return (Va = c.stackRestore = c.asm.ra).apply(null, arguments);
      }, Wa = c.stackAlloc = function() {
        return (Wa = c.stackAlloc = c.asm.sa).apply(null, arguments);
      }, Qa = c._memalign = function() {
        return (Qa = c._memalign = c.asm.ta).apply(null, arguments);
      };
      c.UTF8ToString = J;
      ...
      function Ya() {
        function a() {
          if (!Z && (Z = true, c.calledRun = true, !ea)) {
            ya(pa);
            aa(c);
...
(function(module, exports) {
  var ortWasmThreaded2 = function() {
    ...
    return function(ortWasmThreaded3) {
      ...
      var y = {}, z;
      for (z in v)
        v.hasOwnProperty(z) && (y[z] = v[z]);
      var ja = "./this.program";
      function ka(a, b) {
        throw b;
      }
      var la = typeof window === "object", A = typeof importScripts === "function", B = typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string", C = v.ENVIRONMENT_IS_PTHREAD || false, D = "";
      function ma(a) {
        return v.locateFile ? v.locateFile(a, D) : D + a;
      }
      var F, H, I, J, K;
      if (B) {
        D = A ? require$$3$1.dirname(D) + "/" : __dirname + "/";
        F = function(a, b) {
          J || (J = require$$3$1);
          K || (K = require$$3$1);
          a = K.normalize(a);
        ...
        var oa;
        try {
          oa = require("worker_threads");
        } catch (a) {
          throw console.error('The "worker_threads" module is not supported in this node.js build - perhaps a newer version is needed?'), a;
        }
        commonjsGlobal.Worker = oa.Worker;
      } else if (la || A)
        A ? D = self.location.href : typeof document !== "undefined" && document.currentScript && (D = document.currentScript.src), _scriptDir && (D = _scriptDir), D.indexOf("blob:") !== 0 ? D = D.substr(0, D.lastIndexOf("/") + 1) : D = "", B ? (F = function(a, b) {
          J || (J = require$$3$1);
          K || (K = require$$3$1);
          a = K.normalize(a);
          return J.readFileSync(a, b ? null : "utf8");
      ...
      B && typeof performance === "undefined" && (commonjsGlobal.performance = require$$3$1.performance);
      var pa = v.print || console.log.bind(console), N = v.printErr || console.warn.bind(console);
      for (z in y)
        y.hasOwnProperty(z) && (v[z] = y[z]);
      y = null;
      v.thisProgram && (ja = v.thisProgram);
      v.quit && (ka = v.quit);
      var qa, ra;
      v.wasmBinary && (ra = v.wasmBinary);
      ...
      var va = typeof TextDecoder !== "undefined" ? new ua("utf8") : void 0;
      function wa(a, b, c) {
        var e = b + c;
        for (c = b; a[c] && !(c >= e); )
          ++c;
        ...
        for (e = ""; b < c; ) {
          ...
          if (h & 128) {
            ...
            if ((h & 224) == 192)
              ...
              var m = a[b++] & 63;
              h = (h & 240) == 224 ? (h & 15) << 12 | k << 6 | m : (h & 7) << 18 | k << 12 | m << 6 | a[b++] & 63;
      ...
      typeof TextDecoder !== "undefined" && new ua("utf-16le");
      function Aa(a) {
        var b = za(a) + 1, c = R(b);
        c && xa(a, d(), c, b);
        return c;
      ...
      var Ca = v.INITIAL_MEMORY || 16777216;
      if (C)
        f = v.wasmMemory, l = v.buffer;
      else if (v.wasmMemory)
        f = v.wasmMemory;
      else if (f = new WebAssembly.Memory({ initial: Ca / 65536, maximum: 32768, shared: true }), !(f.buffer instanceof SharedArrayBuffer))
      ...
      Ca = l.byteLength;
      n(l);
      var S, Da = [], Ea = [], Fa = [], Ga = [], Ha = 0;
      function na() {
        return noExitRuntime || 0 < Ha;
      }
      function Ia() {
      ...
      function Pa(a) {
        for (; 0 < a.length; ) {
          ...
          if (typeof b == "function")
            ...
            var c = b.Nb;
            typeof c === "number" ? b.ib === void 0 ? S.get(c)() : S.get(c)(b.ib) : c(b.ib === void 0 ? null : b.ib);
          }
        }
      }
      function Qa(a, b) {
        if (0 >= a || a > d().length || a & 1 || 0 > b)
          return -28;
        if (b == 0)
          return 0;
        2147483647 <= b && (b = Infinity);
        var c = Atomics.load(t(), V >> 2), e = 0;
        if (c == a && Atomics.compareExchange(t(), V >> 2, c, 0) == c && (--b, e = 1, 0 >= b))
          return 1;
        a = Atomics.notify(t(), a >> 2, b);
        if (0 <= a)
          return a + e;
        throw "Atomics.notify returned an unexpected value " + a;
      }
      v._emscripten_futex_wake = Qa;
      function Ra(a) {
        if (C)
        ...
        var b = W.cb[a];
        b && (t()[a + 12 >> 2] = 0, W.sb(b.worker));
      }
      var W = { gb: [], fb: [], zb: [], xc: function() {
      }, Rb: function() {
        for (var a = R(228), b = 0; 57 > b; ++b)
          u()[a / 4 + b] = 0;
        t()[a + 12 >> 2] = a;
        b = a + 152;
        t()[b >> 2] = b;
        ...
        for (b = 0; 128 > b; ++b)
          u()[c / 4 + b] = 0;
        Atomics.store(u(), a + 100 >> 2, c);
        Atomics.store(u(), a + 40 >> 2, a);
        Sa(a, !A, 1);
        Ta(a);
      }, Sb: function() {
        W.receiveObjectTransfer = W.Xb;
        W.threadInit = W.hc;
        W.threadCancel = W.fc;
        W.threadExit = W.Hb;
        W.setExitStatus = W.Zb;
      }, cb: {}, yb: [], Eb: function() {
        for (; 0 < W.yb.length; )
          W.yb.pop()();
        Ua();
      }, Fb: function(a, b) {
        Atomics.store(u(), a + 56 >> 2, 1);
        Atomics.store(u(), a + 60 >> 2, 0);
        W.Eb();
        Atomics.store(u(), a + 4 >> 2, b);
        Atomics.store(u(), a + 0 >> 2, 1);
        Qa(a + 0, 2147483647);
        Sa(0, 0, 0);
      }, Zb: function(a) {
        O = a;
        ...
        var b = X();
        b && (W.Fb(b, a), C && postMessage({ cmd: "exit" }));
      }, fc: function() {
        W.Fb(X(), -1);
        ...
        for (var a in W.cb) {
          var b = W.cb[a];
          b && b.worker && W.sb(b.worker);
        }
        W.cb = {};
        for (a = 0; a < W.gb.length; ++a) {
          var c = W.gb[a];
          c.terminate();
        }
        W.gb = [];
        for (a = 0; a < W.fb.length; ++a)
          c = W.fb[a], b = c.bb, W.xb(b), c.terminate();
        W.fb = [];
      }, xb: function(a) {
        if (a) {
          if (a.eb) {
          ...
          a.wb && a.hb && Va(a.hb);
          a.hb = 0;
          a.worker && (a.worker.bb = null);
        }
      }, sb: function(a) {
        W.Yb(function() {
          delete W.cb[a.bb.eb];
          W.gb.push(a);
          W.fb.splice(W.fb.indexOf(a), 1);
          W.xb(a.bb);
          a.bb = void 0;
        });
      }, Yb: function(a) {
        ...
        a.onmessage = function(c) {
          ...
          if (e.targetThread && e.targetThread != X()) {
            var k = W.cb[e.Dc];
            k ? k.worker.postMessage(c.data, e.transferList) : N('Internal error! Worker sent a message "' + h + '" to target pthread ' + e.targetThread + ", but that thread no longer exists!");
          } else if (h === "processQueuedMainThreadWork")
            Xa();
          else if (h === "spawnThread")
            Ya(c.data);
          else if (h === "cleanupThread")
            Ra(e.thread);
          else if (h === "killThread") {
            c = e.thread;
            if (C)
            ...
            e.worker.terminate();
            W.xb(e);
            W.fb.splice(W.fb.indexOf(e.worker), 1);
            e.worker.bb = void 0;
          } else if (h === "cancelThread") {
            c = e.thread;
            if (C)
            ...
            W.cb[c].worker.postMessage({ cmd: "cancel" });
          } else if (h === "loaded")
            a.loaded = true, b && b(a), a.mb && (a.mb(), delete a.mb);
          else if (h === "print")
            pa("Thread " + e.threadId + ": " + e.text);
          else if (h === "printErr")
            N("Thread " + e.threadId + ": " + e.text);
          else if (h === "alert")
            alert("Thread " + e.threadId + ": " + e.text);
          else if (h === "exit")
            a.bb && Atomics.load(u(), a.bb.eb + 64 >> 2) && W.sb(a);
          else if (h === "exitProcess")
            try {
              Za(e.returnCode);
            } catch (m) {
              if (m instanceof L)
            ...
            h === "cancelDone" ? W.sb(a) : h !== "objectTransfer" && (c.data.target === "setimmediate" ? a.postMessage(c.data) : N("worker sent an unknown command " + h));
          W.Lb = void 0;
        };
        a.onerror = function(c) {
          N("pthread sent an error! " + c.filename + ":" + c.lineno + ": " + c.message);
        };
        B && (a.on("message", function(c) {
          a.onmessage({ data: c });
        }), a.on("error", function(c) {
          a.onerror(c);
        }), a.on("exit", function() {
        }));
        a.postMessage({ cmd: "load", urlOrBlob: v.mainScriptUrlOrBlob || _scriptDir, wasmMemory: f, wasmModule: sa });
      }, Ib: function() {
        var a = ma("ort-wasm-threaded.worker.js");
        W.gb.push(new Worker(a));
      }, Ob: function() {
        W.gb.length == 0 && (W.Ib(), W.Ub(W.gb[0]));
        return W.gb.pop();
      }, nc: function(a) {
        for (a = performance.now() + a; performance.now() < a; )
          ;
      } };
      v.establishStackSpace = function(a, b) {
        $a(a, b);
        ab(a);
      };
      ...
      bb = B ? function() {
        ...
        return performance.now() - v.__performance_now_clock_drift;
      } : function() {
        return performance.now();
      };
      function cb(a, b) {
      ...
      function Ya(a) {
        ...
        W.fb.push(b);
        for (var c = R(512), e = 0; 128 > e; ++e)
          t()[c + 4 * e >> 2] = 0;
        var h = a.hb + a.jb;
        e = W.cb[a.rb] = { worker: b, hb: a.hb, jb: a.jb, wb: a.wb, eb: a.rb };
        var k = e.eb >> 2;
        Atomics.store(u(), k + 16, a.detached);
        Atomics.store(u(), k + 25, c);
        Atomics.store(u(), k + 10, e.eb);
        Atomics.store(u(), k + 20, a.jb);
        Atomics.store(u(), k + 19, h);
        Atomics.store(u(), k + 26, a.jb);
        Atomics.store(u(), k + 28, h);
        Atomics.store(u(), k + 29, a.detached);
        c = hb() + 40;
        Atomics.store(u(), k + 43, c);
        b.bb = e;
        var m = { cmd: "run", start_routine: a.ec, arg: a.ib, threadInfoStruct: a.rb, stackBase: a.hb, stackSize: a.jb };
        b.mb = function() {
          m.time = performance.now();
          b.postMessage(m, a.mc);
        };
        b.loaded && (b.mb(), delete b.mb);
        return 0;
      }
      function ib(a, b, c) {
        ...
        if (la) {
          ...
          c = e + c;
          for (Atomics.exchange(t(), V >> 2, a); ; ) {
            e = performance.now();
            if (e > c)
              return Atomics.exchange(t(), V >> 2, 0), -73;
            e = Atomics.exchange(t(), V >> 2, 0);
            if (e == 0)
              break;
            Xa();
            if (Atomics.load(t(), a >> 2) != b)
              return -6;
            Atomics.exchange(t(), V >> 2, a);
          }
          return 0;
        }
        a = Atomics.wait(t(), a >> 2, b, c);
        if (a === "timed-out")
          return -73;
        if (a === "not-equal")
          return -6;
      ...
      function jb() {
        B || A || (qa || (qa = {}), qa["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] || (qa["Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread"] = 1, N("Blocking on the main thread is very dangerous, see https://emscripten.org/docs/porting/pthreads.html#blocking-on-the-main-browser-thread")));
      }
      function kb(a, b) {
        if (!a)
        ...
        if (Atomics.load(u(), a + 64 >> 2))
          return N("Attempted to join thread " + a + ", which was already detached!"), 28;
        for (jb(); ; ) {
          var c = Atomics.load(u(), a + 0 >> 2);
          if (c == 1)
            return c = Atomics.load(u(), a + 4 >> 2), b && (t()[b >> 2] = c), Atomics.store(u(), a + 64 >> 2, 1), C ? postMessage({ cmd: "cleanupThread", thread: a }) : Ra(a), 0;
          mb();
          C || Xa();
          ib(a + 0, c, C ? 100 : 1);
        }
      ...
      function pb(a, b) {
        var c = ob[a];
        b === 0 || b === 10 ? ((a === 1 ? pa : N)(wa(c, 0)), c.length = 0) : c.push(b);
      }
      var qb = {};
      function rb(a, b) {
        if (C)
      ...
      function yb(a, b, c, e, h, k) {
        if (C)
          b = Y(9, 1, a, b, c, e, h, k);
        else if (k <<= 12, (e & 16) !== 0 && a % 65536 !== 0)
          b = -28;
        else if ((e & 32) !== 0) {
          var m = 65536 * Math.ceil(b / 65536);
          (a = zb(65536, m)) ? q().fill(0, a, a + m) : a = 0;
          a ? (nb[a] = { Wb: a, Tb: b, Jb: true, fd: h, Ac: c, flags: e, offset: k }, b = a) : b = -48;
        } else
          b = -52;
        return b;
      }
      function Ab(a, b) {
        if (C)
          ...
          var c = nb[a];
          b !== 0 && c ? (b === c.Tb && (nb[a] = null, c.Jb && Va(c.Wb)), a = 0) : a = -28;
        }
        return a;
      }
      function Bb(a, b, c) {
      ...
      var Hb = [];
      function Y(a, b) {
        for (var c = arguments.length - 2, e = Ib(), h = Jb(8 * c), k = h >> 3, m = 0; m < c; m++) {
          var r = arguments[2 + m];
          ea()[k + m] = r;
        }
        c = Kb(a, c, h, b);
      ...
      var Lb = [], Mb = [0, typeof document !== "undefined" ? document : 0, typeof window !== "undefined" ? window : 0];
      function Nb(a) {
        a = 2 < a ? P(a) : a;
        return Mb[a] || (typeof document !== "undefined" ? document.querySelector(a) : void 0);
      }
      function Ob(a, b, c) {
        var e = Nb(a);
        if (!e)
          return -4;
        e.qb && (t()[e.qb >> 2] = b, t()[e.qb + 4 >> 2] = c);
        if (e.Db || !e.pc)
          e.Db && (e = e.Db), a = false, e.pb && e.pb.ob && (a = e.pb.ob.getParameter(2978), a = a[0] === 0 && a[1] === 0 && a[2] === e.width && a[3] === e.height), e.width = b, e.height = c, a && e.pb.ob.viewport(0, 0, b, c);
        else {
          if (e.qb) {
            e = t()[e.qb + 8 >> 2];
            a = a ? P(a) : "";
            var h = Ib(), k = Jb(12), m = 0;
            if (a) {
              m = za(a) + 1;
              var r = R(m);
              ya(a, r, m);
      ...
      function Qb(a, b, c) {
        return C ? Y(17, 1, a, b, c) : Ob(a, b, c);
      }
      function Rb(a) {
        if (!ta) {
          try {
            ...
            if (b instanceof L)
              return;
            if (b !== "unwind")
              throw b && typeof b === "object" && b.stack && N("exception thrown: " + [b, b.stack]), b;
          }
          if (!na())
            try {
              C ? Sb(O) : Za(O);
      ...
      function Tb(a) {
        ...
        }, a.drawElementsInstanced = function(c, e, h, k, m) {
          b.drawElementsInstancedANGLE(c, e, h, k, m);
        });
      }
      function Ub(a) {
      ...
      function Wb(a, b) {
        a.Cb || (a.Cb = a.getContext, a.getContext = function(e, h) {
          h = a.Cb(e, h);
      ...
      function Xb(a, b) {
        var c = R(8);
        t()[c + 4 >> 2] = X();
        var e = { wc: c, attributes: b, version: b.Vb, ob: a };
        a.canvas && (a.canvas.pb = e);
        (typeof b.Bb === "undefined" || b.Bb) && Yb(e);
        return c;
      }
      function Yb(a) {
        a || (a = Zb);
        if (!a.Qb) {
          ...
          Ub(b);
          Vb(b);
          b.qc = b.getExtension("EXT_disjoint_timer_query");
          b.zc = b.getExtension("WEBGL_multi_draw");
          (b.getSupportedExtensions() || []).forEach(function(c) {
            c.includes("lose_context") || c.includes("debug") || b.getExtension(c);
          });
        }
      }
      var Zb, $b = ["default", "low-power", "high-performance"], ac = {};
      function bc() {
        if (!cc) {
          var a = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator === "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: ja || "./this.program" }, b;
          for (b in ac)
            ac[b] === void 0 ? delete a[b] : a[b] = ac[b];
          var c = [];
          for (b in a)
            c.push(b + "=" + a[b]);
          cc = c;
      ...
      function kc(a, b, c, e) {
        if (C)
          return Y(22, 1, a, b, c, e);
        a = qb.vc(a);
        b = qb.uc(a, b, c);
        t()[e >> 2] = b;
        return 0;
      }
      function lc(a, b, c, e, h) {
        if (C)
          return Y(23, 1, a, b, c, e, h);
      }
      function mc(a, b, c, e) {
        if (C)
          return Y(24, 1, a, b, c, e);
        for (var h = 0, k = 0; k < c; k++) {
          for (var m = t()[b + 8 * k >> 2], r = t()[b + (8 * k + 4) >> 2], x = 0; x < r; x++)
            pb(a, q()[m + x]);
          h += r;
        }
        t()[e >> 2] = h;
      ...
      function oc() {
        ...
        if (!oc.Kb) {
          oc.Kb = true;
          var b = new Date().getFullYear(), c = new Date(b, 0, 1), e = new Date(b, 6, 1);
          b = c.getTimezoneOffset();
          var h = e.getTimezoneOffset(), k = Math.max(b, h);
          t()[pc() >> 2] = 60 * k;
          t()[qc() >> 2] = Number(b != h);
          c = a(c);
          e = a(e);
          c = Aa(c);
          e = Aa(e);
          h < b ? (t()[Z() >> 2] = c, t()[Z() + 4 >> 2] = e) : (t()[Z() >> 2] = e, t()[Z() + 4 >> 2] = c);
        }
      }
      function rc(a) {
        return a % 4 === 0 && (a % 100 !== 0 || a % 400 === 0);
      ...
      function vc(a, b) {
        for (a = new Date(a.getTime()); 0 < b; ) {
          var c = a.getMonth(), e = (rc(a.getFullYear()) ? tc : uc)[c];
          if (b > e - a.getDate())
      ...
      function wc(a, b, c, e) {
        function h(g, p, w) {
          for (g = typeof g === "number" ? g.toString() : g || ""; g.length < p; )
            g = w[0] + g;
          return g;
        }
        function k(g, p) {
        ...
        function m(g, p) {
          function w(gc) {
            return 0 > gc ? -1 : 0 < gc ? 1 : 0;
          }
          var Q;
          (Q = w(g.getFullYear() - p.getFullYear())) === 0 && (Q = w(g.getMonth() - p.getMonth())) === 0 && (Q = w(g.getDate() - p.getDate()));
          return Q;
        }
        function r(g) {
          switch (g.getDay()) {
        ...
        function x(g) {
          g = vc(new Date(g.ab + 1900, 0, 1), g.vb);
          var p = new Date(g.getFullYear() + 1, 0, 4), w = r(new Date(g.getFullYear(), 0, 4));
          p = r(p);
          return 0 >= m(w, g) ? 0 >= m(p, g) ? g.getFullYear() + 1 : g.getFullYear() : g.getFullYear() - 1;
        }
        var E = t()[e + 40 >> 2];
        e = { kc: t()[e >> 2], jc: t()[e + 4 >> 2], tb: t()[e + 8 >> 2], nb: t()[e + 12 >> 2], kb: t()[e + 16 >> 2], ab: t()[e + 20 >> 2], ub: t()[e + 24 >> 2], vb: t()[e + 28 >> 2], Ec: t()[e + 32 >> 2], ic: t()[e + 36 >> 2], lc: E ? P(E) : "" };
        c = P(c);
        E = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y", "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y" };
        for (var G in E)
          c = c.replace(new RegExp(G, "g"), E[G]);
        var hc = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), ic = "January February March April May June July August September October November December".split(" ");
        E = { "%a": function(g) {
          return hc[g.ub].substring(0, 3);
        }, "%A": function(g) {
          return hc[g.ub];
        }, "%b": function(g) {
          return ic[g.kb].substring(0, 3);
        }, "%B": function(g) {
          return ic[g.kb];
        }, "%C": function(g) {
          return k((g.ab + 1900) / 100 | 0, 2);
        }, "%d": function(g) {
          return k(g.nb, 2);
        }, "%e": function(g) {
          return h(g.nb, 2, " ");
        }, "%g": function(g) {
          return x(g).toString().substring(2);
        }, "%G": function(g) {
          return x(g);
        }, "%H": function(g) {
          return k(g.tb, 2);
          ...
          return k(g.nb + sc(rc(g.ab + 1900) ? tc : uc, g.kb - 1), 3);
        }, "%m": function(g) {
          return k(g.kb + 1, 2);
        }, "%M": function(g) {
          return k(g.jc, 2);
          ...
          var p = new Date(g.ab + 1900, 0, 1), w = p.getDay() === 0 ? p : vc(p, 7 - p.getDay());
          g = new Date(g.ab + 1900, g.kb, g.nb);
          return 0 > m(w, g) ? k(Math.ceil((31 - w.getDate() + (sc(rc(g.getFullYear()) ? tc : uc, g.getMonth() - 1) - 31) + g.getDate()) / 7), 2) : m(w, p) === 0 ? "01" : "00";
        }, "%V": function(g) {
          var p = new Date(g.ab + 1901, 0, 4), w = r(new Date(g.ab + 1900, 0, 4));
          p = r(p);
          var Q = vc(new Date(g.ab + 1900, 0, 1), g.vb);
          return 0 > m(Q, w) ? "53" : 0 >= m(p, Q) ? "01" : k(Math.ceil((w.getFullYear() < g.ab + 1900 ? g.vb + 32 - w.getDate() : g.vb + 1 - w.getDate()) / 7), 2);
        }, "%w": function(g) {
          return g.ub;
        }, "%W": function(g) {
          var p = new Date(g.ab, 0, 1), w = p.getDay() === 1 ? p : vc(p, p.getDay() === 0 ? 1 : 7 - p.getDay() + 1);
          g = new Date(g.ab + 1900, g.kb, g.nb);
          return 0 > m(w, g) ? k(Math.ceil((31 - w.getDate() + (sc(rc(g.getFullYear()) ? tc : uc, g.getMonth() - 1) - 31) + g.getDate()) / 7), 2) : m(w, p) === 0 ? "01" : "00";
        }, "%y": function(g) {
          return (g.ab + 1900).toString().substring(2);
        }, "%Y": function(g) {
          return g.ab + 1900;
        }, "%z": function(g) {
          g = g.ic;
        ...
        for (G in E)
          c.includes(G) && (c = c.replace(new RegExp(G, "g"), E[G](e)));
        G = xc(c);
        if (G.length > b)
          return 0;
        Ba(G, a);
      ...
      var yc = [null, eb, rb, sb, tb, ub, vb, wb, xb, yb, Ab, Bb, Cb, Db, Eb, Fb, Gb, Qb, dc, ec, fc, jc, kc, lc, mc, oc];
      function xc(a) {
        var b = Array(za(a) + 1);
        xa(a, b, 0, b.length);
        return b;
      ...
      var Ac = {
        h: function(a, b, c, e) {
          M("Assertion failed: " + P(a) + ", at: " + [b ? P(b) : "unknown filename", c, e ? P(e) : "unknown function"]);
        },
        M: function(a, b) {
          return cb(a, b);
        },
        ...
        Z: function(a, b, c, e) {
          ...
          if (b && b != -1) {
            ...
            r = 2097152;
          (b = k == 0) ? k = zb(16, r) : (k -= r, assert2(0 < k));
          for (var x = R(228), E = 0; 57 > E; ++E)
            u()[(x >> 2) + E] = 0;
          t()[a >> 2] = x;
          t()[x + 12 >> 2] = x;
          a = x + 152;
          t()[a >> 2] = a;
          c = { hb: k, jb: r, wb: b, detached: m, ec: c, rb: x, ib: e, mc: h };
          return C ? (c.oc = "spawnThread", postMessage(c, h), 0) : Ya(c);
        },
        X: function(a) {
          C ? W.Hb(a) : (W.Eb(), Za(a));
          throw "unwind";
        ...
        ea: function(a, b, c) {
          ...
          var e;
          for (c >>= 2; e = q()[b++]; )
            (e = 105 > e) && c & 1 && c++, Hb.push(e ? ea()[c++ >> 1] : t()[c]), ++c;
          return Oa[a].apply(null, Hb);
        },
        G: jb,
        n: function() {
        },
        ...
        o: function() {
          return B ? require$$3$1.cpus().length : navigator.hardwareConcurrency;
        },
        aa: function(a, b, c) {
          Lb.length = b;
          c >>= 3;
          for (var e = 0; e < b; e++)
            Lb[e] = ea()[c + e];
          return (0 > a ? Oa[-a - 1] : yc[a]).apply(null, Lb);
        },
        E: function(a) {
          var b = q().length;
          a >>>= 0;
          ...
          for (var c = 1; 4 >= c; c *= 2) {
            ...
            a: {
              try {
                f.grow(Math.min(2147483648, e) - l.byteLength + 65535 >>> 16);
                n(f.buffer);
                var h = 1;
                break a;
              } catch (k) {
        ...
        ca: function(a, b) {
          b >>= 2;
          var c = t()[b + 6];
          b = { alpha: !!t()[b], depth: !!t()[b + 1], stencil: !!t()[b + 2], antialias: !!t()[b + 3], premultipliedAlpha: !!t()[b + 4], preserveDrawingBuffer: !!t()[b + 5], powerPreference: $b[c], failIfMajorPerformanceCaveat: !!t()[b + 7], Vb: t()[b + 8], yc: t()[b + 9], Bb: t()[b + 10], Mb: t()[b + 11], Bc: t()[b + 12], Cc: t()[b + 13] };
          a = Nb(a);
          return !a || b.Mb ? 0 : Wb(a, b);
        },
        I: dc,
        J: ec,
        m: fc,
        ...
        y: function(a) {
          oc();
          var b = new Date(t()[a + 20 >> 2] + 1900, t()[a + 16 >> 2], t()[a + 12 >> 2], t()[a + 8 >> 2], t()[a + 4 >> 2], t()[a >> 2], 0), c = t()[a + 32 >> 2], e = b.getTimezoneOffset(), h = new Date(b.getFullYear(), 0, 1), k = new Date(b.getFullYear(), 6, 1).getTimezoneOffset(), m = h.getTimezoneOffset(), r = Math.min(m, k);
          0 > c ? t()[a + 32 >> 2] = Number(k != m && r == e) : 0 < c != (r == e) && (k = Math.max(m, k), b.setTime(b.getTime() + 6e4 * ((0 < c ? r : k) - e)));
          t()[a + 24 >> 2] = b.getDay();
      ...
      (function() {
        function a(h, k) {
          ...
          W.zb.push(v.asm.Ha);
          sa = k;
          C || (T--, v.monitorRunDependencies && v.monitorRunDependencies(T), T == 0 && (Ka && (h = Ka, Ka = null, h())));
        }
        function b(h) {
          a(h.instance, h.module);
        }
        function c(h) {
          return Na().then(function(k) {
        ...
        var e = { a: Ac };
        C || (T++, v.monitorRunDependencies && v.monitorRunDependencies(T));
        if (v.instantiateWasm)
          try {
            return v.instantiateWasm(e, a);
          } catch (h) {
            return N("Module.instantiateWasm callback failed with error: " + h), false;
          }
        (function() {
          return ra || typeof WebAssembly.instantiateStreaming !== "function" || La() || U.startsWith("file://") || typeof fetch !== "function" ? c(b) : fetch(U, { credentials: "same-origin" }).then(function(h) {
      ...
      v.___wasm_call_ctors = function() {
        return (v.___wasm_call_ctors = v.asm.ia).apply(null, arguments);
      };
      v._OrtInit = function() {
        return (v._OrtInit = v.asm.ja).apply(null, arguments);
      };
      v._OrtCreateSessionOptions = function() {
        return (v._OrtCreateSessionOptions = v.asm.ka).apply(null, arguments);
      };
      v._OrtAddSessionConfigEntry = function() {
        return (v._OrtAddSessionConfigEntry = v.asm.la).apply(null, arguments);
      };
      v._OrtReleaseSessionOptions = function() {
        return (v._OrtReleaseSessionOptions = v.asm.ma).apply(null, arguments);
      };
      v._OrtCreateSession = function() {
        return (v._OrtCreateSession = v.asm.na).apply(null, arguments);
      };
      v._OrtReleaseSession = function() {
        return (v._OrtReleaseSession = v.asm.oa).apply(null, arguments);
      };
      v._OrtGetInputCount = function() {
        return (v._OrtGetInputCount = v.asm.pa).apply(null, arguments);
      };
      v._OrtGetOutputCount = function() {
        return (v._OrtGetOutputCount = v.asm.qa).apply(null, arguments);
      };
      v._OrtGetInputName = function() {
        return (v._OrtGetInputName = v.asm.ra).apply(null, arguments);
      };
      v._OrtGetOutputName = function() {
        return (v._OrtGetOutputName = v.asm.sa).apply(null, arguments);
      };
      v._OrtFree = function() {
        return (v._OrtFree = v.asm.ta).apply(null, arguments);
      };
      v._OrtCreateTensor = function() {
        return (v._OrtCreateTensor = v.asm.ua).apply(null, arguments);
      };
      v._OrtGetTensorData = function() {
        return (v._OrtGetTensorData = v.asm.va).apply(null, arguments);
      };
      v._OrtReleaseTensor = function() {
        return (v._OrtReleaseTensor = v.asm.wa).apply(null, arguments);
      };
      v._OrtCreateRunOptions = function() {
        return (v._OrtCreateRunOptions = v.asm.xa).apply(null, arguments);
      };
      v._OrtAddRunConfigEntry = function() {
        return (v._OrtAddRunConfigEntry = v.asm.ya).apply(null, arguments);
      };
      v._OrtReleaseRunOptions = function() {
        return (v._OrtReleaseRunOptions = v.asm.za).apply(null, arguments);
      };
      v._OrtRun = function() {
        return (v._OrtRun = v.asm.Aa).apply(null, arguments);
      };
      v._OrtEndProfiling = function() {
        return (v._OrtEndProfiling = v.asm.Ba).apply(null, arguments);
      };
      var R = v._malloc = function() {
        return (R = v._malloc = v.asm.Da).apply(null, arguments);
      }, db = v.___errno_location = function() {
        return (db = v.___errno_location = v.asm.Ea).apply(null, arguments);
      }, Va = v._free = function() {
        return (Va = v._free = v.asm.Fa).apply(null, arguments);
      }, X = v._pthread_self = function() {
        return (X = v._pthread_self = v.asm.Ga).apply(null, arguments);
      };
      v._emscripten_tls_init = function() {
        return (v._emscripten_tls_init = v.asm.Ha).apply(null, arguments);
      };
      v._emscripten_current_thread_process_queued_calls = function() {
        return (v._emscripten_current_thread_process_queued_calls = v.asm.Ia).apply(null, arguments);
      };
      var Ta = v._emscripten_register_main_browser_thread_id = function() {
        return (Ta = v._emscripten_register_main_browser_thread_id = v.asm.Ja).apply(null, arguments);
      }, lb = v._emscripten_main_browser_thread_id = function() {
        return (lb = v._emscripten_main_browser_thread_id = v.asm.Ka).apply(null, arguments);
      }, zc = v._emscripten_sync_run_in_main_thread_4 = function() {
        return (zc = v._emscripten_sync_run_in_main_thread_4 = v.asm.La).apply(null, arguments);
      }, Xa = v._emscripten_main_thread_process_queued_calls = function() {
        return (Xa = v._emscripten_main_thread_process_queued_calls = v.asm.Ma).apply(null, arguments);
      }, Kb = v._emscripten_run_in_main_runtime_thread_js = function() {
        return (Kb = v._emscripten_run_in_main_runtime_thread_js = v.asm.Na).apply(null, arguments);
      }, Pb = v.__emscripten_call_on_thread = function() {
        return (Pb = v.__emscripten_call_on_thread = v.asm.Oa).apply(null, arguments);
      }, mb = v._pthread_testcancel = function() {
        return (mb = v._pthread_testcancel = v.asm.Pa).apply(null, arguments);
      }, Sb = v._pthread_exit = function() {
        return (Sb = v._pthread_exit = v.asm.Qa).apply(null, arguments);
      }, Sa = v.__emscripten_thread_init = function() {
        return (Sa = v.__emscripten_thread_init = v.asm.Ra).apply(null, arguments);
      }, hb = v._emscripten_get_global_libc = function() {
        return (hb = v._emscripten_get_global_libc = v.asm.Sa).apply(null, arguments);
      }, Ua = v.___pthread_tsd_run_dtors = function() {
        return (Ua = v.___pthread_tsd_run_dtors = v.asm.Ta).apply(null, arguments);
      }, Z = v.__get_tzname = function() {
        return (Z = v.__get_tzname = v.asm.Ua).apply(null, arguments);
      }, qc = v.__get_daylight = function() {
        return (qc = v.__get_daylight = v.asm.Va).apply(null, arguments);
      }, pc = v.__get_timezone = function() {
        return (pc = v.__get_timezone = v.asm.Wa).apply(null, arguments);
      }, Ib = v.stackSave = function() {
        return (Ib = v.stackSave = v.asm.Xa).apply(null, arguments);
      }, ab = v.stackRestore = function() {
        return (ab = v.stackRestore = v.asm.Ya).apply(null, arguments);
      }, Jb = v.stackAlloc = function() {
        return (Jb = v.stackAlloc = v.asm.Za).apply(null, arguments);
      }, $a = v._emscripten_stack_set_limits = function() {
        return ($a = v._emscripten_stack_set_limits = v.asm._a).apply(null, arguments);
      }, zb = v._memalign = function() {
        return (zb = v._memalign = v.asm.$a).apply(null, arguments);
      }, Wa = v.__emscripten_allow_main_runtime_queued_calls = 688928, V = v.__emscripten_main_thread_futex = 694164;
      v.UTF8ToString = P;
      v.stringToUTF8 = ya;
      v.lengthBytesUTF8 = za;
      v.keepRuntimeAlive = na;
      v.PThread = W;
      v.stackSave = Ib;
      v.stackRestore = ab;
      v.stackAlloc = Jb;
      ...
      function Dc() {
        function a() {
          if (!Bc && (Bc = true, v.calledRun = true, !ta)) {
            C || Pa(Ea);
            ha(v);
        ...
        if (!(0 < T))
          if (C)
            ha(v), C || Pa(Ea), postMessage({ cmd: "loaded" });
          else {
            if (!C) {
              if (v.preRun)
            ...
            0 < T || (v.setStatus ? (v.setStatus("Running..."), setTimeout(function() {
              setTimeout(function() {
                v.setStatus("");
              }, 1);
              a();
      ...
      function Za(a) {
        ...
        na() || (W.Gb(), C || (Pa(Fa), typeof _fflush !== "undefined" && _fflush(0), ob[1].length && pb(1, 10), ob[2].length && pb(2, 10)));
        O = a;
        if (!na()) {
          W.Gb();
          if (v.onExit)
...
const ortWasmFactoryThreaded = !BUILD_DEFS.DISABLE_WASM_THREAD ? ortWasmThreaded$1.exports : ort_wasm_js_1.default;
let wasm;
  ...
  tasks.push(new Promise((resolve, reject) => {
    ...
    const config = {
      locateFile: (fileName, scriptDirectory) => {
        if (!BUILD_DEFS.DISABLE_WASM_THREAD && useThreads && fileName.endsWith(".worker.js") && typeof Blob !== "undefined") {
...
const setRunOptions = (options) => {
  ...
  try {
    ...
    if ((options === null || options === void 0 ? void 0 : options.extra) !== void 0) {
      options_utils_1$1.iterateExtraOptions(options.extra, "", new WeakSet(), (key, value) => {
...
class OnnxruntimeWebAssemblySessionHandler {
  ...
  async run(feeds, fetches, options) {
    ...
    Object.entries(feeds).forEach((kvp) => {
      const name2 = kvp[0];
      const tensor2 = kvp[1];
      const index2 = this.inputNames.indexOf(name2);
      if (index2 === -1) {
        throw new Error(`invalid input '${name2}'`);
      }
      inputArray.push(tensor2);
      inputIndices.push(index2);
    });
    const outputIndices = [];
    Object.entries(fetches).forEach((kvp) => {
      const name2 = kvp[0];
      const index2 = this.outputNames.indexOf(name2);
      if (index2 === -1) {
        throw new Error(`invalid output '${name2}'`);
      }
      outputIndices.push(index2);
    });
...
var index = /* @__PURE__ */ getDefaultExportFromCjs(lib$1);
var ort = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": index
}, [lib$1]));
export { ort as default };
