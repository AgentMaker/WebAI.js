 ...
 */
export declare type SerializableTensor = [Tensor.Type, readonly number[], Tensor.DataType];
/**
 *  tuple elements are: InferenceSession handle; input names; output names
 */
export declare type SerializableSessionMetadata = [number, string[], string[]];
...
export declare type OrtWasmMessage = MessageInitWasm | MessageInitOrt | MessageCreateSession | MessageReleaseSession | MessageRun | MesssageEndProfiling;
export {};
