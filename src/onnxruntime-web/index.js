  ...
  `;
    ...
    const createElementwiseProgramInfo = (handler, metadata, input, glslFunc) => {
        ...
        return Object.assign(Object.assign({}, metadata), {
            output: { dims: input.dims, type: input.type, textureType }, shaderSource: `
     ${glslFunc.body}
     void main() {
...
const createGemmProgramInfo = (metadata, inputs, attributes) => {
    ...
    return Object.assign(Object.assign({}, metadata), {
        output: { dims: outputShape, type: inputs[0].type, textureType: types_1$a.TextureType.unpacked }, variables: [
...
const createImageScalerProgramInfo = (handler, metadata, inputs, attributes) => {
    ...
    return Object.assign(Object.assign({}, metadata), {
        output: { dims: outputShape, type: inputs[0].type, textureType: types_1$9.TextureType.unpacked }, variables: [
...
(function (exports) {
    ...
    float process(int indices[2]) {
      ...
      return y0 + float(x_offset) * (y1 - y0) / float(scales[1]);
        ...
        return Object.assign(Object.assign({}, upsampleProgramMetadata), {
            output: { dims: outputShape, type: inputs[0].type, textureType: types_12.TextureType.unpacked }, shaderSource, variables: [{
                name: "scales",
                type: "int",
...
const createPackedResizeProgramInfo = (inferenceHandler2, inputs, attributes) => {
    ...
    if (isSame) {
        return Object.assign(Object.assign({}, resizeProgramMetadata), {
            output: { dims: outputShape, type: inputs[0].type, textureType: types_1$5.TextureType.packed }, hasMain: true, shaderSource: `void main() {
...
if (typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string") {
    ...
    Object.assign(commonjsGlobal, {
        self: commonjsGlobal, require: commonjsRequire, Module, location: { href: __filename }, Worker: nodeWorkerThreads.Worker, importScripts: function (f) {
...
var ort = /* @__PURE__ */ getDefaultExportFromCjs(lib$1);
var InferenceSession$2 = lib$1.InferenceSession;
var Tensor$3 = lib$1.Tensor;
var env$1 = lib$1.env;
var registerBackend$1 = lib$1.registerBackend;
export { InferenceSession$2 as InferenceSession, Tensor$3 as Tensor, ort as default, env$1 as env, registerBackend$1 as registerBackend };
